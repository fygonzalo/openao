#ifndef OPENAO_GAME_CHARACTER_EVENTS_CHARACTERDETAIL_H
#define OPENAO_GAME_CHARACTER_EVENTS_CHARACTERDETAIL_H
...
struct CharacterDetail : framework::IEvent {
  struct Skill {
    uint8_t id;
    uint16_t current;
    uint16_t next;
...
#endif// OPENAO_GAME_CHARACTER_EVENTS_CHARACTERDETAIL_H