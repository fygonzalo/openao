#ifndef OPENAO_GAME_CHARACTER_EVENTS_LOADFUNCTIONBAREVENT_H
#define OPENAO_GAME_CHARACTER_EVENTS_LOADFUNCTIONBAREVENT_H
...
struct LoadFunctionBarEvent : framework::IEvent {
...
#endif// GAME_CHARACTER_EVENTS_LOADFUNCTIONBAREVENT_H