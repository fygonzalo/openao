#ifndef OPENAO_GAME_INVENTORY_EVENTS_LOADINVENTORYEVENT_H
#define OPENAO_GAME_INVENTORY_EVENTS_LOADINVENTORYEVENT_H
...
struct LoadInventoryEvent : framework::IEvent {
...
#endif// OPENAO_GAME_INVENTORY_EVENTS_LOADINVENTORYEVENT_H