...
#ifndef OPENAO_FRAMEWORK_TRANSPORT_MESSAGESTREAM_H
#define OPENAO_FRAMEWORK_TRANSPORT_MESSAGESTREAM_H
...
using namespace openao::framework::security;
...
#endif// OPENAO_FRAMEWORK_TRANSPORT_MESSAGESTREAM_H
