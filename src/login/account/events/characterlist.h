...
#ifndef OPENAO_LOGIN_ACCOUNT_EVENTS_CHARACTERLIST_H
#define OPENAO_LOGIN_ACCOUNT_EVENTS_CHARACTERLIST_H
...
#endif// OPENAO_LOGIN_ACCOUNT_EVENTS_CHARACTERLIST_H
