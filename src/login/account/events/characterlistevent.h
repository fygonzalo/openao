...
#ifndef OPENAO_LOGIN_ACCOUNT_EVENTS_CHARACTERLISTEVENT_H
#define OPENAO_LOGIN_ACCOUNT_EVENTS_CHARACTERLISTEVENT_H
...
#endif// OPENAO_LOGIN_ACCOUNT_EVENTS_CHARACTERLISTEVENT_H
