#ifndef OPENAO_LOGIN_ACCOUNT_EVENTS_ANNOUNCEMENT_H
#define OPENAO_LOGIN_ACCOUNT_EVENTS_ANNOUNCEMENT_H
...
struct Announcement : framework::IEvent {
...
#endif// OPENAO_LOGIN_ACCOUNT_EVENTS_ANNOUNCEMENT_H
